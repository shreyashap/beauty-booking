      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li>
              <Link href="/artists" className="text-sm hover:text-[#ff3479]">
                Artists
              </Link>
            </li>
            <li>
              <Link href="/booking" className="text-sm hover:text-[#ff3479]">
                Book
              </Link>
            </li>
            <li>
              <Link
                href="/my-bookings"
                className="text-sm hover:text-[#ff3479]"
              >
                My Bookings
              </Link>
            </li>
            <li>
              <Link href="/" className="text-sm hover:text-[#ff3479]">
                Home
              </Link>
            </li>
          </ul>
